...
fn run(cli: Cli) -> Result<()> {
    match cli.command {
        ...
        Commands::Sync {
            ...
            force,
            repair_native_stack,
        } => cmd::sync::run(dry_run, autostash, force, repair_native_stack),
        ...
        Commands::Log { json, native_stack } => cmd::log::run(json, native_stack),
        Commands::Status { json, native_stack } => cmd::status::run(json, native_stack),
        ...
        Commands::Config(args) => match args.command {
            ...
            ConfigCommands::Unset { key } => cmd::config::unset(&key),
        },
